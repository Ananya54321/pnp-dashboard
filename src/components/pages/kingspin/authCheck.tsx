      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-md border border-gray-200 dark:border-gray-700">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">URL Shortener Dashboard</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Enter access code to continue</p>
          </div>
          
          <div className="space-y-4">
            <div>
              <label htmlFor="access-code" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">
                Access Code
              </label>
              <Input
                id="access-code"
