...
export const OAuthButton: React.FC<OAuthButtonProps> = ({
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className={`w-full ${config.bgColor} ${config.textColor} ${config.borderColor} hover:${config.textColor} ${className}`}
      onClick={handleClick}
...
// Individual provider components for convenience
export const GoogleOAuthButton: React.FC<Omit<OAuthButtonProps, 'provider'>> = (props) => (
  <OAuthButton provider="google" {...props} />
);

export const GitHubOAuthButton: React.FC<Omit<OAuthButtonProps, 'provider'>> = (props) => (
